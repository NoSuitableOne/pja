...
class Query(object):
    ...
    def select_entity_from(self, from_obj):
        ...
        services.  Suppose
        a views ``user_view`` also returns rows from ``user``.    If
        we reflect this views into a :class:`.Table`, this views has no
    ...
    def merge_result(self, iterator, load=True):
        ...
        this :class:`.Query` - if these do not correspond, unchecked error
        will occur.
