...
class Dialect(object):
    ...
    def get_view_names(self, connection, schema=None, **kw):
        """Return a list of all views names available in the database.
    ...
    def reset_isolation_level(self, dbapi_conn):
        ...
        .. seealso::
            ...
            :meth:`.Connection.get_isolation_level` - views current level

            :attr:`.Connection.default_isolation_level` - views default level
