...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def define_temp_tables(cls, metadata):
        ...
        if testing.requires.view_reflection.enabled and \
            ...
            event.listen(
                ...
                DDL("create temporary views user_tmp_v as "
                    "select * from user_tmp")
            )
            event.listen(
                user_tmp, "before_drop",
                DDL("drop views user_tmp_v")
            )
    ...
    def test_get_view_names(self):
        self._test_get_table_names(table_type='views')

    @testing.requires.view_column_reflection
    @testing.requires.schemas
    def test_get_view_names_with_schema(self):
        self._test_get_table_names(
            testing.config.test_schema, table_type='views')
    ...
    def test_get_view_columns(self):
        self._test_get_columns(table_type='views')

    @testing.requires.view_column_reflection
    @testing.requires.schemas
    def test_get_view_columns_with_schema(self):
        self._test_get_columns(
            schema=testing.config.test_schema, table_type='views')
