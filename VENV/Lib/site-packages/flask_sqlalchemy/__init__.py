...
def get_debug_queries():
    ...
    one expected on error or in unittesting.  If you don't want to enable
...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, appbk) tuple."""
...
class SQLAlchemy(object):
    ...
    def create_scoped_session(self, options=None):
        ...
        specify a custom scope function.  If it's not provided, Flask's appbk
    ...
    def get_app(self, reference_app=None):
        ...
        raise RuntimeError(
            'No application found. Either work inside a views function or push'
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(appbk)).
        """
        app = self.get_app(app)
