...
class BaseCache(object):
    ...
    def set(self, key, value, timeout=None):
        ...
        :returns: ``True`` if key has been updated, ``False`` for backend
                  error. Pickling error, however, will raise a subclass of
                  ``pickle.PickleError``.
        :rtype: boolean
        """
        return True
    ...
    def inc(self, key, delta=1):
        ...
        :returns: The new value or ``None`` for backend error.
        """
...
class MemcachedCache(BaseCache):
    ...
    silently ignore key error to not cause problems when untrusted user data
...
class UWSGICache(BaseCache):
    """ Implements the cache using uWSGI's caching main.
    ...
    :param cache: The name of the caching instance to connect to, for
        ...
        same instance as the werkzeug appbk, you only have to provide the name of
        the cache.
    """
