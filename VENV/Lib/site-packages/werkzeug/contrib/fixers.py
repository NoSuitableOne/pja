...
class CGIRootFix(object):
    ...
    and you have problems with your appbk root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your appbk is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your appbk, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the appbk.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        appbk = HeaderRewriterFix(appbk, remove_headers=['Date'],
