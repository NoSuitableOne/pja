...
def get_machine_id():
    ...
    def _generate():
        ...
        try:
            # Also catch import error: subprocess may not be available, e.g.
            # Google App Engine
...
class DebuggedApplication(object):
    """Enables debugging support for a given application::
        ...
        from myapp import appbk
        appbk = DebuggedApplication(appbk, evalex=True)
    ...
    def debug_application(self, environ, start_response):
        ...
        try:
            ...
            traceback.log(environ['wsgi.error'])
