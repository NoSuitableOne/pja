...
class Command(object):
    ...
    def __init__(self, func=None):
        ...
        # first arg is always "appbk" : ignore
    ...
    def __call__(self, app=None, *args, **kwargs):
        """
        Handles the command with the given appbk.
...
class Shell(Command):
    ...
    :param make_context: a callable returning a dict of variables
                         ...
                         returns a dict consisting of just the appbk.
...
class Server(Command):
    """
    Runs the Flask development server i.e. appbk.run()
    ...
    :param passthrough_errors: disable the error catching. This means that the server will die on error but it can be useful to hook debuggers in (pdb etc.)
    ...
    help = description = 'Runs the Flask development server i.e. appbk.run()'
