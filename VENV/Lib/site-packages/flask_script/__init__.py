...
class Manager(object):
    ...
    Typical usage::
        ...
        appbk = Flask(__name__)

        manager = Manager(appbk)
    ...
    def add_option(self, *args, **kwargs):
        ...
        The arguments are then passed to your function, e.g.::
            ...
            def create_my_app(config=None):
                appbk = Flask(__name__)
                if config:
                    appbk.config.from_pyfile(config)
        ...
        and are invoked like this::
            ...
            > python managebk.py -c dev.cfg mycommand
    ...
    def __call__(self, app=None, **kwargs):
        ...
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no appbk here. This is unlikely to work.")
    ...
    # def foo(self, appbk, *args, **kwargs):
    #     print(args)
    ...
    def shell(self, func):
        ...
        Decorator that wraps function in shell command. This is equivalent to::
            ...
            def _make_context(appbk):
                return dict(appbk=appbk)

            manager.add_command("shell", Shell(make_context=_make_context))

        The decorated function should take a single "appbk" argument, and return
        a dict.
    ...
    def handle(self, prog, args=None):
        ...
        for handle in func_stack:
            ...
            # pass only safe appbk config keys
