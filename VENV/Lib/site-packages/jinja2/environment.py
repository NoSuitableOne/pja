...
class Environment(object):
    ...
    def compile_templates(self, target, extensions=None, filter_func=None,
        ...
        By default template compilation error are ignored.  In case a
        log function is provided, error are logged.  If you want template
        syntax error to abort the compilation you can set `ignore_errors`
        to `False` and you will get an exception on syntax error.
